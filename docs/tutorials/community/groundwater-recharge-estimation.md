...
```
```
/tmpfs/tmp/ipykernel_41129/1140476268.py:2: FutureWarning: 'Y' is deprecated and will be removed in a future version, please use 'YE' instead.
 rdfy = rdf.resample("Y").sum()
...
```
```
/tmpfs/tmp/ipykernel_41129/891754906.py:9: FutureWarning: 'Y' is deprecated and will be removed in a future version, please use 'YE' instead.
 rdf2y = rdf2.resample("Y").sum()
