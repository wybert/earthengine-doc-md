...
![NOAA/GOES/16/MCMIPF](https://developers.google.com/earth-engine/datasets/images/NOAA/NOAA_GOES_16_MCMIPF_sample.png) 
...
Earth Engine Snippet
     `    ee.ImageCollection("NOAA/GOES/16/MCMIPF")   ` [ open_in_new ](https://code.earthengine.google.com/?scriptPath=Examples:Datasets/NOAA/NOAA_GOES_16_MCMIPF) 
...
[Description](https://developers.google.com/earth-engine/datasets/catalog/NOAA_GOES_16_MCMIPF#description)[Bands](https://developers.google.com/earth-engine/datasets/catalog/NOAA_GOES_16_MCMIPF#bands)[Image Properties](https://developers.google.com/earth-engine/datasets/catalog/NOAA_GOES_16_MCMIPF#image-properties)[Terms of Use](https://developers.google.com/earth-engine/datasets/catalog/NOAA_GOES_16_MCMIPF#terms-of-use)[Citations](https://developers.google.com/earth-engine/datasets/catalog/NOAA_GOES_16_MCMIPF#citations)[DOIs](https://developers.google.com/earth-engine/datasets/catalog/NOAA_GOES_16_MCMIPF#dois) More
...
[Code Editor (JavaScript)](https://developers.google.com/earth-engine/datasets/catalog/NOAA_GOES_16_MCMIPF#code-editor-javascript-sample) More
```
// Band aliases.
varBLUE='CMI_C01';
varRED='CMI_C02';
...
[ GOES-16 MCMIPF Series ABI Level 2 Cloud and Moisture Imagery Full Disk ](https://developers.google.com/earth-engine/datasets/catalog/NOAA_GOES_16_MCMIPF)
The Cloud and Moisture Imagery products are all at 2km resolution. Bands 1-6 are reflective. The dimensionless "reflectance factor" quantity is normalized by the solar zenith angle. These bands support the characterization of clouds, vegetation, snow/ice, and aerosols. Bands 7-16 are emissive. The brightness temperature at the Top-Of-Atmosphere (TOA) is …
NOAA/GOES/16/MCMIPF, abi,atmosphere,goes,goes-16,goes-east,goes-r,mcmip,nesdis,noaa,ospo,satellite-imagery,weather 
2017-07-10T00:00:00Z/2025-04-07T18:30:20.600000Z
-90 -180 90 180 
Google Earth Engine
