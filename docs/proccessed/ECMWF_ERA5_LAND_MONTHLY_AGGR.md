...
`lake_mix_layer_depth_max` | m | maximum lake_mix_layer_depth value each month  
...
`surface_thermal_radiation_downwards_max` | J/m^2 | maximum surface_thermal_radiation_downwards value each month  
