...
[Description](https://developers.google.com/earth-engine/datasets/catalog/NOAA_GOES_17_MCMIPF#description)[Bands](https://developers.google.com/earth-engine/datasets/catalog/NOAA_GOES_17_MCMIPF#bands)[Image Properties](https://developers.google.com/earth-engine/datasets/catalog/NOAA_GOES_17_MCMIPF#image-properties)[Terms of Use](https://developers.google.com/earth-engine/datasets/catalog/NOAA_GOES_17_MCMIPF#terms-of-use)[Citations](https://developers.google.com/earth-engine/datasets/catalog/NOAA_GOES_17_MCMIPF#citations)[DOIs](https://developers.google.com/earth-engine/datasets/catalog/NOAA_GOES_17_MCMIPF#dois) More
...
[Code Editor (JavaScript)](https://developers.google.com/earth-engine/datasets/catalog/NOAA_GOES_17_MCMIPF#code-editor-javascript-sample) More
```
// Band aliases.
varBLUE='CMI_C01';
varRED='CMI_C02';
