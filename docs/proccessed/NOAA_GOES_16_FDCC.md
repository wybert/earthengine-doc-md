...
[Description](https://developers.google.com/earth-engine/datasets/catalog/NOAA_GOES_16_FDCC#description)[Bands](https://developers.google.com/earth-engine/datasets/catalog/NOAA_GOES_16_FDCC#bands)[Terms of Use](https://developers.google.com/earth-engine/datasets/catalog/NOAA_GOES_16_FDCC#terms-of-use)[Citations](https://developers.google.com/earth-engine/datasets/catalog/NOAA_GOES_16_FDCC#citations)[DOIs](https://developers.google.com/earth-engine/datasets/catalog/NOAA_GOES_16_FDCC#dois) More
...
[Code Editor (JavaScript)](https://developers.google.com/earth-engine/datasets/catalog/NOAA_GOES_16_FDCC#code-editor-javascript-sample) More
```
