...
```
{
  ...
  "permissions": enum (TilePermissions[](https://developers.google.com/earth-engine/reference/rest/v1/CloudStorageDestination#TilePermissions)),
  "bucketCorsUris": [
    string
  ]
}
...
`permissions` |  `enum (`TilePermissions[](https://developers.google.com/earth-engine/reference/rest/v1/CloudStorageDestination#TilePermissions)`)` Specifies the permissions to set on the exported tiles. If unspecified, defaults to DEFAULT_OBJECT_ACL.  
