...
Usage | Returns  
---|---  
`BBox.contains(right, _maxError_, _proj_)`|  Boolean  
...
## Examples
[Code Editor (JavaScript)](https://developers.google.com/earth-engine/apidocs/ee-geometry-bbox-contains#code-editor-javascript-sample)[Colab (Python)](https://developers.google.com/earth-engine/apidocs/ee-geometry-bbox-contains#colab-python-sample) More
```
...
varbBoxContains=bBox.contains({'right':inputGeom,'maxError':1});
