...
Usage | Returns  
---|---  
`Map.getBounds(_asGeoJSON_)`|  GeoJSONGeometry|List<Number>|String  
Argument | Type | Details  
---|---|---  
this: `ui.map` | ui.Map | The ui.Map instance.  
`asGeoJSON` | Boolean, optional | If true, returns map bounds as GeoJSON.  
## Examples
[Code Editor (JavaScript)](https://developers.google.com/earth-engine/apidocs/ui-map-getbounds#code-editor-javascript-sample) More
```
