...
![](https://developers.google.com/static/earth-engine/images/Reducers_linearFit.png)  
Figure 1. The output of `linearFit()` applied to projected precipitation. Areas projected to be increased precipitation are shown in blue and decreased precipitation in red.
### `linearRegression()`
...
![](https://developers.google.com/static/earth-engine/images/Reducers_scatterplot.png)  
